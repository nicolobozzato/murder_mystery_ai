  ...
  >
    ...
    <div class="d-flex align-items-center flex-wrap">
      ...
      <div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
        <router-link to="/teachers/" class="active btn btn-icon btn-sm me-1 primary-hover"
          ><i class="ti ti-list-tree"></i
        ></router-link>
        <router-link
          to="/teachers/teacher-grid"
...
export default {
  data() {
    return {
      TeacherName: ["Teresa", "Daniel", "Hellana"],
      TeacherClass: ["I", "II", "III"],
  ...
  methods: {
    submitForm() {
      this.$router.push("/teachers/teachers-list");
    },
  },
};
</script>
