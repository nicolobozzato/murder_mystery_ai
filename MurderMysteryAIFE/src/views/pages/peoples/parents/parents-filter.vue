  ...
  >
    ...
    <div class="d-flex align-items-center flex-wrap">
      ...
      <div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
        <router-link to="/parents/parents" class="btn btn-icon btn-sm me-1 primary-hover"
          ><i class="ti ti-list-tree"></i
        ></router-link>
        <router-link to="/parents/parent-grid" class="btn btn-icon btn-sm primary-hover"
...
export default {
  data() {
    return {
      ChildGrid: ["Select", "Janet", "Joann", "kathleen"],
      ParentGrid: ["Select", "Thomas", "marquita", "Johnson"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/parents/parents");
    },
  },
  setup() {
