    ...
    <div class="d-flex align-items-center flex-wrap">
      ...
      <div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
        <router-link
          ...
          class="btn btn-icon btn-sm me-1 bg-light primary-hover"
          ><i class="ti ti-list-tree"></i
        ></router-link>
        <router-link to="/students/student-grid" class="btn btn-icon btn-sm primary-hover"
...
export default {
  data() {
    return {
      ClassGridStud: ["Select", "I", "II", "III"],
      SecGridStud: ["Select", "A", "B", "C"],
      NameGridSel: ["Select", "Janet", "Joann", "Kathleen"],
      GenderGridStud: ["Select", "Male", "Female"],
      StatusGridStud: ["Select", "Active", "Inactive"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/students/student-grid");
    },
  },
  setup() {
