    ...
    <div class="d-flex align-items-center flex-wrap">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="Class" id="classes" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label">Section</label>
                    <vue-select :options="Section" id="sections" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue-select :options="Gender" id="gender" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
      ...
      <div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
        <router-link
          ...
          class="active btn btn-icon btn-sm me-1 primary-hover"
          ><i class="ti ti-list-tree"></i
        ></router-link>
        <router-link
          to="/students/student-grid"
          class="btn btn-icon btn-sm bg-light primary-hover"
...
export default {
  data() {
    return {
      Class: ["I", "II", "III"],
      Section: ["A", "B", "C"],
      StudentName: ["Janet", "Joann", "Kathleen"],
      Gender: ["Male", "Female"],
