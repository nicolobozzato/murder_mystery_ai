<template>
  ...
  >
    <h4 class="mb-3">Teacher Attendance</h4>
...
export default {
  data() {
    return {
      ...
      TeacherIdSel: [
        ...
        { label: "T849127", value: "T849127" },
        { label: "T849125", value: "T849125" },
        { label: "T849126", value: "T849126" },
      ],
      TeacherNameSel: [
        { label: "Select", value: "Select" },
  ...
  methods: {
    submitForm() {
      this.$router.push("/attendence/teacher-attendance");
    },
  },
  setup() {
