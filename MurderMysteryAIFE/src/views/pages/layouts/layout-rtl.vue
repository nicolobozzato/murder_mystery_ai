<template>
  ...
  <div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <router-link
              ...
              ><i class="ti ti-square-rounded-plus ms-2"></i>Add New Student</router-link
            >
          </div>
          <div class="mb-2">
            <router-link
      ...
      <div class="row">
        <rtl-admin-banner></rtl-admin-banner>
      </div>

      <div class="row">
        <rtl-admin-student></rtl-admin-student>
      </div>

      <div class="row">
        <rtl-admin-schedules></rtl-admin-schedules>
      </div>
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  ><i class="ti ti-calendar ms-2"></i>Last 8 Quater
                </a>
            ...
            <div class="card-body pb-0">
              <div id="fees-chart">
                <apexchart
                  type="bar"
                  height="275"
                  :options="feesCharts.AdminFees"
                  :series="feesCharts.series"
                >
                </apexchart>
              </div>
            </div>
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  class="bg-white dropdown-toggle"
                  data-bs-toggle="dropdown"
                  ><i class="ti ti-calendar-due ms-1"></i>Today
                </a>
                <ul class="dropdown-menu mt-2 p-3">
                  <li>
                    <a href="javascript:void(0);" class="dropdown-item rounded-1">
              ...
              <div class="card mb-2">
                <div class="card-body p-3">
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center overflow-hidden ms-2">
                      <a
                        href="javascript:void(0);"
                        class="avatar avatar-lg flex-shrink-0 ms-2"
                      >
                      ...
                      <div class="overflow-hidden">
                        <h6 class="mb-1 text-truncate">
                          ...
                          ><span class="badge badge-soft-danger ms-1">Emergency</span>
                        </h6>
                    ...
                    <div class="d-flex align-items-center">
                      <a
                        href="javascript:void(0);"
                        class="avatar avatar-xs p-0 btn btn-success ms-1"
                        ><i class="ti ti-checks"></i
                      ></a>
                      <a
                        href="javascript:void(0);"
                        class="avatar avatar-xs p-0 btn btn-danger"
                        ><i class="ti ti-x"></i
                      ></a>
                    </div>
                  </div>
                  ...
                  >
                    <p class="mb-0">
                      Leave : <span class="fw-semibold">12 -13 May</span>
                    </p>
                    ...
                    <div class="d-flex align-items-center overflow-hidden ms-2">
                      ...
                      <div class="overflow-hidden">
                        <h6 class="mb-1 text-truncate">
                          ...
                          ><span class="badge badge-soft-warning ms-1">Casual</span>
                        </h6>
      ...
      <div class="row">
          ...
          >
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span class="avatar avatar-lg bg-warning rounded flex-shrink-0 ms-2"
                ...
                <span
                  class="btn btn-white warning-btn-hover avatar avatar-sm p-0 flex-shrink-0 rounded-circle"
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          <router-link
            to="/announcements/event-list"
            class="card bg-success-transparent border border-5 border-white animate-card flex-fill"
          >
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span class="avatar avatar-lg bg-success rounded flex-shrink-0 ms-2"
                    ><i class="ti ti-speakerphone fs-24"></i
                  ></span>
                  <div class="overflow-hidden">
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          <router-link
            to="/membership/membership-plans"
            class="card bg-danger-transparent border border-5 border-white animate-card flex-fill"
          >
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span class="avatar avatar-lg bg-danger rounded flex-shrink-0 ms-2"
                    ><i class="ti ti-sphere fs-24"></i
                  ></span>
                  <div class="overflow-hidden">
                ...
                <span
                  class="btn btn-white avatar avatar-sm p-0 flex-shrink-0 rounded-circle danger-btn-hover"
                  ><i class="ti ti-chevron-right fs-14"></i
                ></span>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          ...
          >
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <span class="avatar avatar-lg bg-secondary rounded flex-shrink-0 ms-2"
                ...
                <span
                  class="btn btn-white secondary-btn-hover avatar avatar-sm p-0 flex-shrink-0 rounded-circle"
                  ><i class="ti ti-chevron-right fs-14"></i
                ></span>
              </div>
            </div>
          ...
          <div class="card flex-fill">
            ...
            <div id="total-earning">
              <apexchart
                type="area"
                height="90"
                :options="earningCharts.TotalCharts"
                :series="earningCharts.series"
              >
              </apexchart>
            </div>
          </div>
          <div class="card flex-fill">
            ...
            <div id="total-expenses">
              <apexchart
                type="area"
                height="90"
                :options="expensesCharts.Total"
                :series="expensesCharts.series"
              >
              </apexchart>
            </div>
          </div>
        ...
        <div class="col-xxl-5 col-xl-12 order-3 order-xxl-2 d-flex">
          <div class="card flex-fill">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <router-link to="/announcements/notice-board" class="fw-medium"
            ...
            <div class="card-body">
              <div class="notice-widget">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <div
                    class="d-flex align-items-center overflow-hidden ms-2 mb-2 mb-sm-0"
                  >
                    <span
                      class="bg-primary-transparent avatar avatar-md ms-2 rounded-circle flex-shrink-0"
                    >
                      <i class="ti ti-books fs-16"></i>
                    </span>
                    <div class="overflow-hidden">
                      <h6 class="text-truncate mb-1">New Syllabus Instructions</h6>
                      <p><i class="ti ti-calendar ms-2"></i>Added on : 11 Mar 2024</p>
                    </div>
                  </div>
                  <span class="badge bg-light text-dark"
                    ><i class="ti ti-clck ms-1"></i>20 Days</span
                  >
                </div>
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <div
                  ...
                  >
                    <span
                      class="bg-success-transparent avatar avatar-md ms-2 rounded-circle flex-shrink-0"
                    >
                    ...
                    <div class="overflow-hidden">
                      ...
                      <p><i class="ti ti-calendar ms-2"></i>Added on : 21 Apr 2024</p>
                    </div>
                  </div>
                  <span class="badge bg-light text-dark"
                    ><i class="ti ti-clck ms-1"></i>15 Days</span
                  >
                </div>
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <div
                  ...
                  >
                    <span
                      class="bg-danger-transparent avatar avatar-md ms-2 rounded-circle flex-shrink-0"
                    >
                      <i class="ti ti-bell-check fs-16"></i>
                    </span>
                    <div class="overflow-hidden">
                      <h6 class="text-truncate mb-1">Exam Preparation Notification!</h6>
                      <p><i class="ti ti-calendar ms-2"></i>Added on : 13 Mar 2024</p>
                    </div>
                  </div>
                  <span class="badge bg-light text-dark"
                    ><i class="ti ti-clck ms-1"></i>12 Days</span
                  >
                </div>
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <div
                  ...
                  >
                    <span
                      class="bg-skyblue-transparent avatar avatar-md ms-2 rounded-circle flex-shrink-0"
                    >
                      <i class="ti ti-notes fs-16"></i>
                    </span>
                    <div class="overflow-hidden">
                      <h6 class="text-truncate mb-1">Online Classes Preparation</h6>
                      <p><i class="ti ti-calendar ms-2"></i>Added on : 24 May 2024</p>
                    </div>
                  </div>
                  <span class="badge bg-light text-dark"
                    ><i class="ti ti-clck ms-1"></i>02 Days</span
                  >
                </div>
                <div class="d-sm-flex align-items-center justify-content-between mb-0">
                  ...
                  >
                    <span
                      class="bg-warning-transparent avatar avatar-md ms-2 rounded-circle flex-shrink-0"
                    >
                  ...
                  <span class="badge bg-light text-dark"
                    ><i class="ti ti-clck ms-1"></i>06 Days</span
                  >
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-end justify-content-between">
                ...
                <span class="badge badge-soft-success"
                  ><i class="ti ti-chart-line ms-1"></i>1.2%</span
                >
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-xl-6 d-flex">
          <div class="card flex-fill">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  class="bg-white dropdown-toggle"
                  data-bs-toggle="dropdown"
                  ><i class="ti ti-school-bell ms-2"></i>Class II
                </a>
                <ul class="dropdown-menu mt-2 p-3">
                  <li>
                    <a href="javascript:void(0);" class="dropdown-item rounded-1">
            ...
            <div class="card-body">
              <div
                class="alert alert-success d-flex align-items-center mb-24"
                role="alert"
              >
                <i class="ti ti-info-square-rounded ms-2 fs-14"></i>
                <div class="fs-14">
                  These Result are obtained from the syllabus completion on the respective
                  Class
                </div>
              </div>
              <ul class="list-group">
                ...
                <li class="list-group-item">
                  <div class="row align-items-center">
                    ...
                    <div class="col-sm-8">
                      <div class="progress progress-xs flex-grow-1">
                        <div
                          class="progress-bar bg-secondary rounded"
                          role="progressbar"
                          style="width: 30%"
                          aria-valuenow="30"
                          aria-valuemin="0"
        ...
        <div class="col-xxl-4 col-xl-6 d-flex">
          <div class="card flex-fill">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  class="bg-white dropdown-toggle"
                  data-bs-toggle="dropdown"
                  ><i class="ti ti-calendar ms-2"></i>This Month
                </a>
                <ul class="dropdown-menu mt-2 p-3">
                  <li>
                    <a href="javascript:void(0);" class="dropdown-item rounded-1">
            ...
            <div class="card-body">
              <div
                class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded"
              >
                <span class="avatar avatar-lg flex-shrink-0 rounded ms-2">
              ...
              <div
                class="d-flex align-items-center overflow-hidden p-3 mb-0 border rounded"
              >
                <span class="avatar avatar-lg flex-shrink-0 rounded ms-2">
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  class="bg-white dropdown-toggle"
                  data-bs-toggle="dropdown"
                  ><i class="ti ti-calendar ms-2"></i>Today
                </a>
                <ul class="dropdown-menu mt-2 p-3">
                  <li>
                    <a href="javascript:void(0);" class="dropdown-item rounded-1">
              ...
              <ul class="list-group list-group-flush todo-list">
                <li class="list-group-item py-3 px-0 pt-0">
                  <div class="d-sm-flex align-items-center justify-content-between">
                    <div
                      class="d-flex align-items-center overflow-hidden ms-2"
                ...
                <li class="list-group-item py-3 px-0">
                  <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <span class="badge badge-soft-warning mt-2 mt-sm-0"
                      >Yet to Start</span
                    >
                  </div>
                </li>
...
<script>
import { feesCharts, expensesCharts, earningCharts } from "./dataone";
export default {
  data() {
    return {
      feesCharts: feesCharts,
