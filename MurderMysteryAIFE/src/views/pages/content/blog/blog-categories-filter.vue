...
export default {
  data() {
    return {
      ...
      AddedDateSelect: [
        { label: "Select", value: "Select" },
        { label: "25 May 2024", value: "25 May 2024" },
        { label: "24 May 2024", value: "24 May 2024" },
        { label: "15 Mar 2024", value: "15 Mar 2024" },
      ],
      InactiveSelec: [
        { label: "Select", value: "Select" },
  ...
  methods: {
    submitForm() {
      this.$router.push("/blogs/blog-Categories");
    },
  },
  setup() {
