              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="ClassSece" v-model="selectedOne" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Status</label>
                    <vue3-select :options="SeleSts" v-model="selectedTwo" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
