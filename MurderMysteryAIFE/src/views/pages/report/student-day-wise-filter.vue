...
export default {
  data() {
    return {
      ...
      selectedTwo: null,
      AttendDateWise: [
        { label: "Attendance Date", value: "Attendance Date" },
  ...
  methods: {
    submitForm() {
      this.$router.push("/reports/student-day-wise");
    },
  },
  setup() {
