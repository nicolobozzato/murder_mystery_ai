              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="ModeSele" v-model="selectedOne" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="GpsSelec" v-model="selectedThree" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
  ...
  data() {
    return {
      ...
      VchiSelec: [
        ...
        {label: "4625", value: "4625"},
      ],
      ModeSele: [
        {label: "Select", value: "Select"}, 
        {label: "Scania", value: "Scania"}, 
        {label: "Mini Bus", value: "Mini Bus"}, 
        {label: "Kinsmart", value: "Kinsmart"}, 
        {label: "Single deck", value: "Single deck"}, 
      ],
      NamJanSelec: [
        {label: "Select", value: "Select"}, 
      ...
      GpsSelec: [
        {label: "Select", value: "Select"},
        {label: "GPS7899456689", value: "GPS7899456689"},
        {label: "GPS4579454785", value: "GPS4579454785"},
        {label: "GPS1478545214", value: "GPS1478545214"},
        {label: "GPS3254789541", value: "GPS3254789541"},
      ],
      DrivSelect: [
        {label: "Select", value: "Select"}, 
      ...
      MadeMoreSel: [
        ...
        {label: "Made of Year", value: "Made of Year"},
        {label: "Registration No", value: "Registration No"},
