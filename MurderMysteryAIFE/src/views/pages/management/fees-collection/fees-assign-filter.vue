              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="GenSelec" v-model="selectedOne" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
                    <label class="form-label">Student Category</label>
                    <vue3-select :options="Categoyj" v-model="selectedTwo" placeholder="Select" />
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/fees/fees-assign");
    },
  },
  setup() {
