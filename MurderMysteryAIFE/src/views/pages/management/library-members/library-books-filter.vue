              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <vue3-select :options="Selechis" v-model="selectedOne" placeholder="Select" />
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="mb-3">
...
export default {
  data() {
    return {
      ...
      MorIFIBook: [
        ...
        {label: "Book Name", value: "Book Name"}, 
        {label: "Book No", value: "Book No"}, 
        {label: "Publisher", value: "Publisher"}, 
        {label: "Author", value: "Author"}, 
        {label: "Subject", value: "Subject"}, 
        {label: "Rack No", value: "Rack No"}, 
      ],
      Selechis: [
        {label: "Select", value: "Select"}, 
  ...
  methods: {
    submitForm() {
      this.$router.push("/library/library-books");
    },
  },
  setup() {
