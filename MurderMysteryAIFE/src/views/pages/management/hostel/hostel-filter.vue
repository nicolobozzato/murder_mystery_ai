...
export default {
  data() {
    return {
      ...
      ResdiSelec: [
        ...
        {label: "Phoneix Resdience", value: "Phoneix Resdience"},
        {label: "Tranquil Heven", value: "Tranquil Heven"},
        {label: "Radiant Towers", value: "Radiant Towers"},
        {label: "Nova Nest", label: "Nova Nest"},
      ...
      FilterHoste: [
        ...
        {label: "Hostel Type", value: "Hostel Type"},
  ...
  methods: {
    submitForm() {
      this.$router.push("/hostel/hostel-list");
    },
  },
  setup() {
