      ...
      <div class="modal-content">
        ...
        <form>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <vue3-select :options="TypeClass" v-model="selected" placeholder="Select" />
                </div>
                <div class="mb-3">
                  <label class="form-label">Start Time </label>
                  <vue3-select :options="StartTime" v-model="selectedOne" placeholder="Select" />
                </div>
                <div class="mb-3">
                  <label class="form-label">End Time </label>
                  <vue3-select :options="EndTime" v-model="selectedTwo" placeholder="Select" />
                </div>
                <div
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Schedule</button>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/classes/schedule-classes");
    },
  },
};
</script>
